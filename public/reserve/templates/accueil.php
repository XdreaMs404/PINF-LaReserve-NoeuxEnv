    ...
    <main class="container">
        ...
        <section class="content-section" style="background-color: var(--white);">
            ...
            <div
                ...
                <p style="margin-bottom:15px; color:#334155;">Retrouvez tous nos événements, chantiers nature, ateliers et visites directement sur notre agenda dédié !</p>
                <a href="index.php?view=agenda" class="btn btn-accent">Visualiser l'agenda complet</a>
            </div>
        </section>
